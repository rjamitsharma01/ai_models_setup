...
# set -e
# cd /root
# curl -fsSL https://raw.githubusercontent.com/rjamitsharma01/ai_models_setup/main/qwen-comfyui/qwen-models-downloader-comfyui.sh | bash
# """
